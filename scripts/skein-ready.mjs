...
export function renderInitBlock(init) {
  const baseComment = {
  ...
  const lines = [
    `// Generated by skein-ready --init from ${init.source}. TEXT ONLY:`,
    "// skein-ready never writes agentic.config.ts -- paste this block into its",
