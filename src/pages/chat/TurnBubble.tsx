    ...
    >
      ...
      {turn.role === "assistant" && (
        <Group gap={4} justify="flex-end" mt={6}>
          <Tooltip label="Good response" openDelay={300} withArrow>
            <ActionIcon
              size="sm"
          ...
          <Tooltip label="Bad response" openDelay={300} withArrow>
            <ActionIcon
              size="sm"
          ...
          {onCollect && (
            <Tooltip label="Collect into benchmark" openDelay={300} withArrow>
              <ActionIcon
                size="sm"
                variant="subtle"
                color="gray"
