    ...
    >
      ...
      {turn.role === "assistant" && (
        <Group gap={4} justify="flex-end" mt={6}>
          <Tooltip label="Thumbs up" position="top" openDelay={400}>
            <ActionIcon
              size="sm"
          ...
          <Tooltip label="Thumbs down" position="top" openDelay={400}>
            <ActionIcon
              size="sm"
          ...
          <CopyButton value={turn.content} timeout={1500}>
            {({ copied, copy }) => (
              <Tooltip label={copied ? "Copied" : "Copy message"} position="top" openDelay={400}>
                <ActionIcon
                  size="sm"
                  variant="subtle"
          ...
          {shareUrl && (
            <CopyButton value={shareUrl} timeout={1500}>
              {({ copied, copy }) => (
                <Tooltip label={copied ? "Link copied" : "Copy link to turn"} position="top" openDelay={400}>
                  <ActionIcon
                    size="sm"
                    variant="subtle"
                    color={copied ? "teal" : "gray"}
          ...
          {onFork && (
            <Tooltip label="Fork turn" position="top" openDelay={400}>
              <ActionIcon
                size="sm"
                variant="subtle"
                color="gray"
          ...
          {/* Collect. One icon in the existing row (same size, same subtle
              ...
              (cupel-phases.md:79). */}
          {onCollect && (
            <Tooltip label="Collect into eval set" position="top" openDelay={400}>
              <ActionIcon
                size="sm"
                variant="subtle"
                color="gray"
          ...
          {onTrace && (
            <Tooltip label="Open trace" position="top" openDelay={400}>
              <ActionIcon
                size="sm"
                variant="subtle"
                color="gray"
