    ...
    >
      ...
      {turn.role === "assistant" && (
        <Group gap={4} justify="flex-end" mt={6}>
          <Tooltip label="Good response" withArrow openDelay={200}>
            <ActionIcon
              size="sm"
          ...
          <Tooltip label="Bad response" withArrow openDelay={200}>
            <ActionIcon
              size="sm"
          ...
          <CopyButton value={turn.content} timeout={1500}>
            {({ copied, copy }) => (
              <Tooltip label={copied ? "Copied!" : "Copy message"} withArrow openDelay={200}>
                <ActionIcon
                  size="sm"
                  variant="subtle"
          ...
          {shareUrl && (
            <CopyButton value={shareUrl} timeout={1500}>
              {({ copied, copy }) => (
                <Tooltip label={copied ? "Link copied!" : "Copy link to turn"} withArrow openDelay={200}>
                  <ActionIcon
                    size="sm"
                    variant="subtle"
                    color={copied ? "teal" : "gray"}
          ...
          {onFork && (
            <Tooltip label="Fork turn" withArrow openDelay={200}>
              <ActionIcon
                size="sm"
                variant="subtle"
                color="gray"
          ...
          {onCollect && (
            <Tooltip label="Collect into eval benchmark" withArrow openDelay={200}>
              <ActionIcon
                size="sm"
                variant="subtle"
                color="gray"
          ...
          {onTrace && (
            <Tooltip label="Open trace" withArrow openDelay={200}>
              <ActionIcon
                size="sm"
                variant="subtle"
                color="gray"
