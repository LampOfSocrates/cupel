    ...
    >
      ...
      {turn.role === "assistant" && (
        <Group gap={4} justify="flex-end" mt={6}>
          <Tooltip label="Thumbs up" openDelay={200} withArrow>
            <ActionIcon
              size="sm"
          ...
          <Tooltip label="Thumbs down" openDelay={200} withArrow>
            <ActionIcon
              size="sm"
          ...
          <CopyButton value={turn.content} timeout={1500}>
            {({ copied, copy }) => (
              <Tooltip label={copied ? "Copied!" : "Copy message"} openDelay={200} withArrow>
                <ActionIcon
                  size="sm"
                  variant="subtle"
          ...
          {shareUrl && (
            <CopyButton value={shareUrl} timeout={1500}>
              {({ copied, copy }) => (
                <Tooltip label={copied ? "Link copied!" : "Copy link to turn"} openDelay={200} withArrow>
                  <ActionIcon
                    size="sm"
                    variant="subtle"
                    color={copied ? "teal" : "gray"}
          ...
          {onFork && (
            <Tooltip label="Fork turn" openDelay={200} withArrow>
              <ActionIcon
                size="sm"
                variant="subtle"
                color="gray"
          ...
          {onCollect && (
            <Tooltip label="Collect into eval benchmark" openDelay={200} withArrow>
              <ActionIcon
                size="sm"
                variant="subtle"
                color="gray"
          ...
          {onTrace && (
            <Tooltip label="Open trace" openDelay={200} withArrow>
              <ActionIcon
                size="sm"
                variant="subtle"
                color="gray"
