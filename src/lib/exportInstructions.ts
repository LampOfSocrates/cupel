// "Download version history to file" (user decision 2026-08-05: file export
// first, repo integration later — that is sequencing, not a withheld feature;
// there is no paid tier). Pure client-side serializers over InstructionHistory exactly as
